...
def getmaxid():
    ...
    """
    cnx = mysql.connector.connect(user='root', password='Jiang0814', host='35.224.182.68')
    cursor = cnx.cursor()
    cursor.execute("USE rds")
...
if __name__ == "__main__":
    create_database("35.185.39.95")
    create_table("35.185.39.95")
    insert_inventory("35.185.39.95")
    create_database("35.224.182.68")
    create_table("35.224.182.68")
    insert_inventory("35.224.182.68")
    create_database("35.193.252.106")
    create_table("35.193.252.106")
    insert_inventory("35.193.252.106")
    # dic = {
    #     'transaction_id': 0,
    #     'product_type': 'shoes',
    #     'number': 7
